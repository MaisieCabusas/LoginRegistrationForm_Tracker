...
namespace LoginRegistrationForm
{
    ...
    {
        SqlConnection connect = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\Maisie\Documents\LoginData.mdf;Integrated Security=True;Connect Timeout=30");
        public Signup()
        {
            InitializeComponent();
        }
                ...
                if (connect.State != ConnectionState.Open)
                {
                    try
                    {
                        ...
                        using (SqlCommand checkUser = new SqlCommand(checkUsername, connect))
                        {
                            ...
                            {
                                string insertData = "INSERT INTO admin (email, username, password, data_created) " +
